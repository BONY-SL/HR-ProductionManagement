...
public class TokenFilters extends OncePerRequestFilter {
    @Autowired
    private JwtResorce jwtUtils;

    @Autowired
    private UserDetailsSer userDetailsService;

    private static final Logger logger = LoggerFactory.getLogger(TokenFilters.class);
